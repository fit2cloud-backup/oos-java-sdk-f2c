 ...
 */
package cn.ctyun.amazonaws.auth.policy.internal;

import java.util.Arrays;
import java.util.LinkedList;
import java.util.List;

import cn.ctyun.amazonaws.auth.policy.Action;
import cn.ctyun.amazonaws.auth.policy.Condition;
import cn.ctyun.amazonaws.auth.policy.Policy;
import cn.ctyun.amazonaws.auth.policy.Principal;
import cn.ctyun.amazonaws.auth.policy.Resource;
import cn.ctyun.amazonaws.auth.policy.Statement;
import cn.ctyun.amazonaws.auth.policy.Principal.Services;
import cn.ctyun.amazonaws.auth.policy.Statement.Effect;
import cn.ctyun.amazonaws.util.json.JSONArray;
