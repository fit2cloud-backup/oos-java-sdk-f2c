...
import cn.ctyun.amazonaws.transform.VoidJsonUnmarshaller;
import cn.ctyun.amazonaws.util.CRC32ChecksumCalculatingInputStream;
/**
...
public class JsonResponseHandler<T> implements HttpResponseHandler<AmazonWebServiceResponse<T>> {
    ...
    /**
     * @see cn.ctyun.amazonaws.http.HttpResponseHandler#handle(cn.ctyun.amazonaws.http.HttpResponse)
     */
     ...
     *
     * @see cn.ctyun.amazonaws.http.HttpResponseHandler#needsConnectionLeftOpen()
     */
