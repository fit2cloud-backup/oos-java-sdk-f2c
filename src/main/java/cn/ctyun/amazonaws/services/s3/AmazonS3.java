...
public interface AmazonS3 {
     ...
     * {@link cn.ctyun.amazonaws.ClientConfiguration} is used.
     * </p>
     * @param endpoint
     ...
     *            {@link cn.ctyun.amazonaws.regions.Region#getRegion(cn.ctyun.amazonaws.regions.Regions)} for
     *            accessing a given region.
     * @throws java.lang.IllegalArgumentException
     *             If the given region is null, or if this service isn't
     *             available in the given region. See
     *             {@link cn.ctyun.amazonaws.regions.Region#isServiceSupported(String)}
     * @see cn.ctyun.amazonaws.regions.Region#getRegion(cn.ctyun.amazonaws.regions.Regions)
     * @see cn.ctyun.amazonaws.regions.Region#createClient(Class, com.amazonaws.auth.AWSCredentialsProvider, ClientConfiguration)
     */
    public void setRegion(cn.ctyun.amazonaws.regions.Region region) throws IllegalArgumentException;
     ...
     *             request.
     *
     * @see cn.ctyun.amazonaws.services.s3.model.Region
     */
    @Deprecated @cn.ctyun.ButUnsupported
     ...
     */
    /**
     * 由于Complete Multipart Upload请求可能需要花费几分钟时间，所以OOS提供了不合并片段也可以读取Object内容的功能。
     * 在没有调用Complete Multipart Upload接口合并片段时，也可以通过调用Get Object接口来获取文件内容，
     * OOS会根据最近一次创建的uploadId，以分片号升序的方式顺序读取片段内容，返回给客户端。但此时不能返回整个Object的ETag值。
     * 
     */
     ...
     * Secret Access Key is accessible only during key creation.
     ...
     *
     * 
     * @return The response from the ctyunCreateAccessKey service method, as
     *         returned by CTYUN.
     * 
     * @throws AmazonClientException
     ...
     * @throws AmazonServiceException
     *             If an error response is returned by CTYUN indicating
     ...
     *           to execute the ctyunDeleteAccessKey service method on
     *           CTYUN.
     * 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
     ...
     * Changes the specified access key from commmon key to primary key, or
     * vice versa.
     * </p>
     * <p>    
     * 
     * @param updateAccessKeyRequest Container for the necessary parameters
     *           to execute the ctyunUpdateAccessKey service method on
     *           CTYUN.
     *   
     *
     * @throws AmazonClientException
     ...
     * <code>BeginNum</code> parameters.
     * </p>
     * <p>
     * <b>NOTE:</b>To ensure the security of your AWS account, the secret
     * access key is accessible only during key creation.
     * </p>
     *
     * @param listAccessKeysRequest Container for the necessary parameters to
     *           execute the ctyunListAccessKeys service method on CTYUN.
     * 
     * @return The response from the ctyunListAccessKeys service method, as
     *         returned by CTYUN.
     *   
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client while
    ...
    /**
     * <p>
     * set the bucket trigger associated with the specified bucket.
     * </p>
     * <p>
     * 
     * @param CtyunSetBucketTriggerConfigurationRequest
     *            Container for the necessary parameters to execute the
     *            ctyunSetBucketTrigger service method on CTYUN.
     * 
     * @throws AmazonClientException
     ...
     * @throws AmazonServiceException
     *             If an error response is returned by CTYUN indicating either a
    ...
    /**
     * <p>
     * get the bucket trigger associated with the specified bucket.
     * </p>
     * <p>
     * 
     * @param bucketName
     *            The name of the bucket for which to get the trigger
     *            configuration.
     * 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client
     ...
     * <p>
     * 
     * @param CtyunGetBucketTriggerConfigurationRequest
     *            Container for the necessary parameters to execute the
     *            ctyunGetBucketTrigger service method on CTYUN.
     * 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client
     *             while attempting to make the request or handle the response.
    ...
    /**
     * <p>
     * delete the bucket trigger associated with the specified bucket.
     * </p>
     * <p>
     * 
     * @param bucketName
     *            The name of the bucket for which to delete the trigger
     *            configuration.
     * 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client
     ...
     * <p>
     * 
     * @param CtyunDeleteBucketTriggerConfigurationRequest
     *            Container for the necessary parameters to execute the
     *            ctyunDeleteBucketTrigger service method on CTYUN.
     * 
     * @throws AmazonClientException
     *             If any internal errors are encountered inside the client
     *             while attempting to make the request or handle the response.
    ...
    public CtyunGetUsageResult ctyunGetUsage(CtyunGetUsageRequest getUsageRequest) 
            throws AmazonServiceException, AmazonClientException;
}