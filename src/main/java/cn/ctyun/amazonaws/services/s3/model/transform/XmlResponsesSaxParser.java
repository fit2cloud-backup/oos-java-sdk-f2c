...
import cn.ctyun.amazonaws.services.identitymanagement.model.AccessKey;
import cn.ctyun.amazonaws.services.identitymanagement.model.AccessKeyMetadata;
...
import cn.ctyun.amazonaws.services.s3.model.CORSRule;
import cn.ctyun.amazonaws.services.s3.model.CanonicalGrantee;
...
import cn.ctyun.amazonaws.services.s3.model.CtyunRemoteSite;
import cn.ctyun.amazonaws.services.s3.model.CtyunTriggerMetadata;
import cn.ctyun.amazonaws.services.s3.model.DeleteObjectsResult;
import cn.ctyun.amazonaws.services.s3.model.EmailAddressGrantee;
...
import cn.ctyun.amazonaws.services.s3.model.MultipartUpload;
...
import cn.ctyun.amazonaws.services.s3.model.PartSummary;
import cn.ctyun.amazonaws.services.s3.model.Permission;
import cn.ctyun.amazonaws.services.s3.model.RedirectRule;
import cn.ctyun.amazonaws.services.s3.model.RoutingRule;
import cn.ctyun.amazonaws.services.s3.model.RoutingRuleCondition;
import cn.ctyun.amazonaws.services.s3.model.S3Object;
import cn.ctyun.amazonaws.services.s3.model.S3ObjectSummary;
import cn.ctyun.amazonaws.services.s3.model.S3VersionSummary;
import cn.ctyun.amazonaws.services.s3.model.StorageClass;
import cn.ctyun.amazonaws.services.s3.model.TagSet;
import cn.ctyun.amazonaws.services.s3.model.VersionListing;
import cn.ctyun.amazonaws.services.s3.model.BucketLifecycleConfiguration.Rule;
import cn.ctyun.amazonaws.services.s3.model.BucketLifecycleConfiguration.Transition;
import cn.ctyun.amazonaws.services.s3.model.BucketNotificationConfiguration.TopicConfiguration;
import cn.ctyun.amazonaws.services.s3.model.CORSRule.AllowedMethods;
import cn.ctyun.amazonaws.services.s3.model.DeleteObjectsResult.DeletedObject;
import cn.ctyun.amazonaws.services.s3.model.MultiObjectDeleteException.DeleteError;
...
public class XmlResponsesSaxParser {
    ...
    public CtyunBucketTriggerConfigurationHandler parseTriggerConfigurationResponse(InputStream inputStream)
            throws AmazonClientException {
        CtyunBucketTriggerConfigurationHandler handler = new CtyunBucketTriggerConfigurationHandler();
        parseXmlInputStream(handler, inputStream);
        return handler;
    }
    ...
    /**
     * Parses a CtyunListAccessKey response XML document from an input stream.
     *
     * @param inputStream
     *            XML data input stream.
     * @return the XML handler object populated with data parsed from the XML
     ...
     * @throws AmazonClientException
     */
    public CtyunListAccessKeyHandler parseCtyunListAccessKey(InputStream inputStream)
            throws AmazonClientException {
        CtyunListAccessKeyHandler handler = new CtyunListAccessKeyHandler();
        parseXmlInputStream(handler, sanitizeXmlDocument(handler, inputStream));
        return handler;
    }
    
    /**
     * Parses a CtyunGetUsage response XML document from an input stream.
     *
     * @param inputStream
     *            XML data input stream.
     * @return the XML handler object populated with data parsed from the XML
     ...
     * @throws AmazonClientException
     */
    public CtyunGetUsageHandler parseCtyunGetUsage(InputStream inputStream)
            throws AmazonClientException {
        CtyunGetUsageHandler handler = new CtyunGetUsageHandler();
        parseXmlInputStream(handler, sanitizeXmlDocument(handler, inputStream));
        return handler;
    }
    
    /**
     * Parses a CtyunCreateAccessKey response XML document from an input stream.
     *
     * @param inputStream
     *            XML data input stream.
     * @return the XML handler object populated with data parsed from the XML
     ...
     * @throws AmazonClientException
     */
    public CtyunCreateAccessKeyHandler parseCtyunCreateAccessKey(InputStream inputStream)
            throws AmazonClientException {
        CtyunCreateAccessKeyHandler handler = new CtyunCreateAccessKeyHandler();
        parseXmlInputStream(handler, sanitizeXmlDocument(handler, inputStream));
        return handler;
    }
    // ////////////
    ...
    public class BucketLoggingConfigurationHandler extends DefaultHandler {
        ...
        private String triggerTargetBucket = null;
        private String triggerTargetPrefix = null;
        private String triggerSourceBucket = null;
        private String triggerSourcePrefix = null;
        private StringBuilder currText = null;
        ...
        public void endElement(String uri, String name, String qName) {
            ...
            if (name.equals("TargetBucket")) {
            ...
            } else if (name.equals("TriggerTargetBucket")) {
                triggerTargetBucket = elementText;
            } else if (name.equals("TriggerTargetPrefix")) {
                triggerTargetPrefix = elementText;
            } else if (name.equals("TriggerSourceBucket")) {
                triggerSourceBucket = elementText;
            } else if (name.equals("TriggerSourcePrefix")) {
                triggerSourcePrefix = elementText;
                ...
                bucketLoggingConfiguration.setCtyunTriggerDestinationBucketName(triggerTargetBucket);
                bucketLoggingConfiguration.setCtyunTriggerDestinationLogFilePrefix(triggerTargetPrefix);
                bucketLoggingConfiguration.setCtyunTriggerSourceBucketName(triggerSourceBucket);
                bucketLoggingConfiguration.setCtyunTriggerSourceLogFilePrefix(triggerSourcePrefix);
            }
            this.currText = new StringBuilder();
        }
    ...
    public class CompleteMultipartUploadHandler extends DefaultHandler implements ServerSideEncryptionResult,
        ...
        /**
         * @see cn.ctyun.amazonaws.services.s3.model.CompleteMultipartUploadResult#getExpirationTime()
         */
        @Override
        public Date getExpirationTime() {
            if ( result != null )
        ...
        /**
         * @see cn.ctyun.amazonaws.services.s3.model.CompleteMultipartUploadResult#setExpirationTime(java.util.Date)
         */
        @Override
        public void setExpirationTime(Date expirationTime) {
            if ( result != null )
        ...
        /**
         * @see cn.ctyun.amazonaws.services.s3.model.CompleteMultipartUploadResult#getExpirationTimeRuleId()
         */
        @Override
        public String getExpirationTimeRuleId() {
            if ( result != null )
        ...
        /**
         * @see cn.ctyun.amazonaws.services.s3.model.CompleteMultipartUploadResult#setExpirationTimeRuleId(java.lang.String)
         */
        @Override
        public void setExpirationTimeRuleId(String expirationTimeRuleId) {
            if ( result != null )
  ...
  <LifecycleConfiguration>
    ...
    */
    ...
    /**
     * Handler for ListAccessKeysResult XML document.
     */
    public class CtyunListAccessKeyHandler extends DefaultHandler {
        private ListAccessKeysResult listAccessKeyResult = null;
        private StringBuilder currText = null;
        private List<AccessKeyMetadata> accessKeyMetadatas = null;
        private AccessKeyMetadata accessKeyMetadata=null;
        
        public CtyunListAccessKeyHandler() {
            super();
            listAccessKeyResult = new ListAccessKeysResult();
            accessKeyMetadata=new AccessKeyMetadata();
            this.currText = new StringBuilder();
        }
        
      
        public ListAccessKeysResult getAccessKeys() {
            return listAccessKeyResult;
        }                    
        ...
        public void startElement(String uri, String name, String qName,
                Attributes attrs) {
            if (name.equals("AccessKeyMetadata")) {
            	  accessKeyMetadatas=new ArrayList<AccessKeyMetadata>();
        ...
        public void endElement(String uri, String name, String qName) {
            ...
            if (name.equals("AccessKeyId")) {
            	accessKeyMetadata.setAccessKeyId(elementText);
            } else if (name.equals("UserName")) {
            	accessKeyMetadata.setUserName(elementText);
            } else if (name.equals("Status")) {
               accessKeyMetadata.setStatus(elementText);
            } else if (name.equals("IsPrimary")) {
            	accessKeyMetadata.setCtyunIsPrimary(Boolean.parseBoolean(elementText));
            } else if (name.equals("member")) {
            	accessKeyMetadatas.add(accessKeyMetadata);
            } else if (name.equals("IsTruncated")) {              
                listAccessKeyResult.setIsTruncated(Boolean.parseBoolean(elementText));
            } else if (name.equals("AccessKeyMetadata")) {              
                listAccessKeyResult.setAccessKeyMetadata(accessKeyMetadatas);
            } else if (name.equals("Marker")) {              
                listAccessKeyResult.setMarker(elementText);
            }
            this.currText = new StringBuilder();
        }
    ...
    /**
     * Handler for GetUsageResult XML document.
     */
    public class CtyunGetUsageHandler extends DefaultHandler {
        private CtyunGetUsageResult getUsageResult = null;
        private StringBuilder currText = null;

        public CtyunGetUsageHandler() {
            super();
            getUsageResult = new CtyunGetUsageResult();
            this.currText = new StringBuilder();
        }

        public CtyunGetUsageResult getUsage() {
        ...
        public void endElement(String uri, String name, String qName) {
            ...
            if (name.equals("UserName")) {
                getUsageResult.setUserName(elementText);
            } else if (name.equals("Date")) {
                getUsageResult.setDate(elementText);
            } else if (name.equals("Capacity")) {
                getUsageResult.setCapacity(Long.parseLong(elementText));
            } else if (name.equals("Upload")) {
                getUsageResult.setUpload(Long.parseLong(elementText));
            } else if (name.equals("Download")) {
                getUsageResult.setDownload(Long.parseLong(elementText));
            } else if (name.equals("GetHeadRequest")) {
                getUsageResult.setGhRequest(Long.parseLong(elementText));
            } else if (name.equals("OtherRequest")) {
                getUsageResult.setOtherRequest(Long.parseLong(elementText));
            }
            this.currText = new StringBuilder();
        }
    ...
    /**
     * Handler for CreateAccessKeyResult XML document.
     */
    public class CtyunCreateAccessKeyHandler extends DefaultHandler {
        private StringBuilder currText = null;
        private CreateAccessKeyResult currentKey = null;
        private AccessKey accessKey;
        
        public CtyunCreateAccessKeyHandler() {
            super();
            this.currText = new StringBuilder();
        }
        
      
        public CreateAccessKeyResult getKey() {
            return currentKey;
        }
        ...
        public void startElement(String uri, String name, String qName,
            ...
            if (name.equals("AccessKey")) {
                currentKey = new CreateAccessKeyResult();
        ...
        public void endElement(String uri, String name, String qName) {
            String elementText = this.currText.toString().trim();
            if (name.equals("AccessKeyId")) {
            	accessKey.setAccessKeyId(elementText);
            } else if (name.equals("SecretAccessKey")) {
            	accessKey.setSecretAccessKey(elementText);
            } else if (name.equals("Status")) {               
                accessKey.setStatus(elementText);               
            } else if (name.equals("IsPrimary")) {               
                accessKey.setCtyunIsPrimary(Boolean.parseBoolean(elementText));               
            } else if (name.equals("AccessKey")) {
            	currentKey.setAccessKey(accessKey);
            }
            this.currText = new StringBuilder();
        }
    ...
    public class CtyunBucketTriggerConfigurationHandler extends DefaultHandler {
        private CtyunBucketTriggerConfiguration configuration = new CtyunBucketTriggerConfiguration();
        private List<CtyunRemoteSite> sites = null;
        private CtyunRemoteSite site = null;
        private StringBuilder text;
        private CtyunTriggerMetadata trigger = null;

        public CtyunBucketTriggerConfiguration getConfiguration() {
        ...
        @Override
        public void startElement(String uri, String name, String qName, Attributes attrs) {
            if (name.equals("TriggerConfiguration")) {
                sites = new ArrayList<CtyunRemoteSite>();
                configuration.setTriggers(new ArrayList<CtyunTriggerMetadata>());
            } else if (name.equals("Trigger")) {
                trigger = new CtyunTriggerMetadata();
            } else if (name.equals("RemoteSite")) {
                site = new CtyunRemoteSite();
            }
        }
        ...
        public void endElement(String uri, String name, String qName) throws SAXException {
            ...
            if (name.equals("TriggerName")) {
                trigger.setTriggerName(elementText);
            } else if (name.equals("IsDefault")) {
                trigger.setDefault(Boolean.parseBoolean(elementText));
            } else if (name.equals("RemontEndPoint")) {
                site.setRemoteEndPoint(elementText);
            } else if (name.equals("ReplicaMode")) {
                site.setReplicaMode(elementText);
            } else if (name.equals("RemoteBucketName")) {
                site.setRemoteBucketName(elementText);
            } else if (name.equals("RemoteAK")) {
                site.setRemoteAK(elementText);
            } else if (name.equals("RemoteSK")) {
                site.setRemoteSK(elementText);
            } else if (name.equals("RemoteSite")) {
                sites.add(site);
            } else if (name.equals("Trigger")) {
                trigger.setRemoteSites(sites);
                configuration.getTriggers().add(trigger);
            }
