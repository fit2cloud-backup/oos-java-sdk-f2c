...
public class ListSigningCertificatesResult  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<SigningCertificate> certificates;
    ...
    public java.util.List<SigningCertificate> getCertificates() {
        ...
        if (certificates == null) {
              certificates = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<SigningCertificate>();
    ...
    public void setCertificates(java.util.Collection<SigningCertificate> certificates) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<SigningCertificate> certificatesCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<SigningCertificate>(certificates.size());
