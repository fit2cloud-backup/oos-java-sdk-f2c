...
public class ListRolePoliciesResult  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> policyNames;
    ...
    public java.util.List<String> getPolicyNames() {
        ...
        if (policyNames == null) {
              policyNames = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>();
    ...
    public void setPolicyNames(java.util.Collection<String> policyNames) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> policyNamesCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>(policyNames.size());
