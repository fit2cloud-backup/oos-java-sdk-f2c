...
public class ListGroupsResult  implements Serializable  {
     ...
     * A list of groups.
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Group> groups;
    ...
    public java.util.List<Group> getGroups() {
        ...
        if (groups == null) {
              groups = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Group>();
    ...
    public void setGroups(java.util.Collection<Group> groups) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Group> groupsCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Group>(groups.size());
