...
public class ListMFADevicesResult  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<MFADevice> mFADevices;
    ...
    public java.util.List<MFADevice> getMFADevices() {
        ...
        if (mFADevices == null) {
              mFADevices = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<MFADevice>();
    ...
    public void setMFADevices(java.util.Collection<MFADevice> mFADevices) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<MFADevice> mFADevicesCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<MFADevice>(mFADevices.size());
