...
public class ListVirtualMFADevicesResult  implements Serializable  {
    ...
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<VirtualMFADevice> virtualMFADevices;
    ...
    public java.util.List<VirtualMFADevice> getVirtualMFADevices() {
        ...
        if (virtualMFADevices == null) {
              virtualMFADevices = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<VirtualMFADevice>();
    ...
    public void setVirtualMFADevices(java.util.Collection<VirtualMFADevice> virtualMFADevices) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<VirtualMFADevice> virtualMFADevicesCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<VirtualMFADevice>(virtualMFADevices.size());
