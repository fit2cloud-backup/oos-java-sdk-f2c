...
public class ListAccessKeysResult  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<AccessKeyMetadata> accessKeyMetadata;
    ...
    public java.util.List<AccessKeyMetadata> getAccessKeyMetadata() {
        ...
        if (accessKeyMetadata == null) {
              accessKeyMetadata = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<AccessKeyMetadata>();
    ...
    public void setAccessKeyMetadata(java.util.Collection<AccessKeyMetadata> accessKeyMetadata) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<AccessKeyMetadata> accessKeyMetadataCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<AccessKeyMetadata>(accessKeyMetadata.size());
