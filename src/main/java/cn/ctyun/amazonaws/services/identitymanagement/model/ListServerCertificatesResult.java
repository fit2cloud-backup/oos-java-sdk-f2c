...
public class ListServerCertificatesResult  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<ServerCertificateMetadata> serverCertificateMetadataList;
    ...
    public java.util.List<ServerCertificateMetadata> getServerCertificateMetadataList() {
        ...
        if (serverCertificateMetadataList == null) {
              serverCertificateMetadataList = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<ServerCertificateMetadata>();
    ...
    public void setServerCertificateMetadataList(java.util.Collection<ServerCertificateMetadata> serverCertificateMetadataList) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<ServerCertificateMetadata> serverCertificateMetadataListCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<ServerCertificateMetadata>(serverCertificateMetadataList.size());
