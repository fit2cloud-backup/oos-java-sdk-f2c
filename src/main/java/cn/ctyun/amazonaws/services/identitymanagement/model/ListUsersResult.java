...
public class ListUsersResult  implements Serializable  {
     ...
     * A list of users.
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<User> users;
    ...
    public java.util.List<User> getUsers() {
        ...
        if (users == null) {
              users = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<User>();
    ...
    public void setUsers(java.util.Collection<User> users) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<User> usersCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<User>(users.size());
