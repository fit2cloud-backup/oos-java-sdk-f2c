...
/**
 * Container for the parameters to the {@link cn.ctyun.amazonaws.services.identitymanagement.AmazonIdentityManagement#updateAccessKey(UpdateAccessKeyRequest) UpdateAccessKey operation}.
 * <p>
 ...
 * </p>
 *
 * @see cn.ctyun.amazonaws.services.identitymanagement.AmazonIdentityManagement#updateAccessKey(UpdateAccessKeyRequest)
 */
public class UpdateAccessKeyRequest extends AmazonWebServiceRequest  implements Serializable  {
    ...
    /**
     * If the access key is a primary key or a common key. <code>true</code> means the key is
     * a primary key, while <code>false</code> means it is not.
     * <p>
     * <b>Constraints:</b><br/>
     ...
     * <b>Allowed Values: </b>true, false
     */
    public void setCtyunIsPrimary(String ctyunIsPrimary) {
        this.ctyunIsPrimary= ctyunIsPrimary;
    }
    /**
