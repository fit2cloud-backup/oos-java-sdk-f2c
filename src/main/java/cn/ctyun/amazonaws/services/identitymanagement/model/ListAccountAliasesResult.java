...
public class ListAccountAliasesResult  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> accountAliases;
    ...
    public java.util.List<String> getAccountAliases() {
        ...
        if (accountAliases == null) {
              accountAliases = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>();
    ...
    public void setAccountAliases(java.util.Collection<String> accountAliases) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> accountAliasesCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>(accountAliases.size());
