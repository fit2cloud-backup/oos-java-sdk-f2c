...
public class InstanceProfile  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Role> roles;
    ...
    public java.util.List<Role> getRoles() {
        ...
        if (roles == null) {
              roles = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Role>();
    ...
    public void setRoles(java.util.Collection<Role> roles) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Role> rolesCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Role>(roles.size());
