...
public class ListInstanceProfilesForRoleResult  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<InstanceProfile> instanceProfiles;
    ...
    public java.util.List<InstanceProfile> getInstanceProfiles() {
        ...
        if (instanceProfiles == null) {
              instanceProfiles = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<InstanceProfile>();
    ...
    public void setInstanceProfiles(java.util.Collection<InstanceProfile> instanceProfiles) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<InstanceProfile> instanceProfilesCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<InstanceProfile>(instanceProfiles.size());
