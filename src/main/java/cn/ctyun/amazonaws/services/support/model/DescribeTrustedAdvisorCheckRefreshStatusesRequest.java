 ...
 */
package cn.ctyun.amazonaws.services.support.model;
import java.io.Serializable;

import cn.ctyun.amazonaws.AmazonWebServiceRequest;

/**
 * Container for the parameters to the {@link cn.ctyun.amazonaws.services.support.AWSSupport#describeTrustedAdvisorCheckRefreshStatuses(DescribeTrustedAdvisorCheckRefreshStatusesRequest) DescribeTrustedAdvisorCheckRefreshStatuses operation}.
 * <p>
 * Returns the status of all refresh requests Trusted Advisor checks called using RefreshTrustedAdvisorCheck.
 * </p>
 *
 * @see cn.ctyun.amazonaws.services.support.AWSSupport#describeTrustedAdvisorCheckRefreshStatuses(DescribeTrustedAdvisorCheckRefreshStatusesRequest)
 */
public class DescribeTrustedAdvisorCheckRefreshStatusesRequest extends AmazonWebServiceRequest  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> checkIds;
    ...
    public java.util.List<String> getCheckIds() {
        ...
        if (checkIds == null) {
              checkIds = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>();
    ...
    public void setCheckIds(java.util.Collection<String> checkIds) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> checkIdsCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>(checkIds.size());
