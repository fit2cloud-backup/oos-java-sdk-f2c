...
/**
 * Container for the parameters to the {@link cn.ctyun.amazonaws.services.support.AWSSupport#describeCases(DescribeCasesRequest) DescribeCases operation}.
 * <p>
 ...
 * </ol>
 *
 * @see cn.ctyun.amazonaws.services.support.AWSSupport#describeCases(DescribeCasesRequest)
 */
public class DescribeCasesRequest extends AmazonWebServiceRequest  implements Serializable  {
     ...
     * <b>Length: </b>0 - 100<br/>
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> caseIdList;
    ...
    public java.util.List<String> getCaseIdList() {
        ...
        if (caseIdList == null) {
              caseIdList = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>();
    ...
    public void setCaseIdList(java.util.Collection<String> caseIdList) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> caseIdListCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>(caseIdList.size());
