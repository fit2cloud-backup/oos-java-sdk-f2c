    ...
    if (createCaseRequest == null) {
        ...
        try {
          ...
          jsonWriter.object();
            ...
            cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> ccEmailAddressesList = (cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>)(createCaseRequest.getCcEmailAddresses());
