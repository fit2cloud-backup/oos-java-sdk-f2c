...
public class TrustedAdvisorResourceDetail  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> metadata;
    ...
    public java.util.List<String> getMetadata() {
        ...
        if (metadata == null) {
              metadata = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>();
    ...
    public void setMetadata(java.util.Collection<String> metadata) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> metadataCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>(metadata.size());
