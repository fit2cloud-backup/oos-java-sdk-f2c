 ...
 */
public class CategoryJsonUnmarshaller implements Unmarshaller<Category, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("code", targetDepth)) {
                    context.nextToken();
                    category.setCode(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    category.setName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CategoryJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CategoryJsonUnmarshaller();
        return instance;
    }
}
