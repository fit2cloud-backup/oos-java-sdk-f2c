...
public class DescribeServicesResult  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Service> services;
    ...
    public java.util.List<Service> getServices() {
        ...
        if (services == null) {
              services = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Service>();
    ...
    public void setServices(java.util.Collection<Service> services) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Service> servicesCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Service>(services.size());
