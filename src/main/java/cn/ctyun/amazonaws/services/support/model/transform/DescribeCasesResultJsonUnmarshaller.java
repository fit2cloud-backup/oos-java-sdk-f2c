...
public class DescribeCasesResultJsonUnmarshaller implements Unmarshaller<DescribeCasesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describeCasesResult.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static DescribeCasesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeCasesResultJsonUnmarshaller();
        return instance;
    }
}
