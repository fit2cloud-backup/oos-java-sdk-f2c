...
public class DescribeTrustedAdvisorChecksResult  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorCheckDescription> checks;
    ...
    public java.util.List<TrustedAdvisorCheckDescription> getChecks() {
        ...
        if (checks == null) {
              checks = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorCheckDescription>();
    ...
    public void setChecks(java.util.Collection<TrustedAdvisorCheckDescription> checks) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorCheckDescription> checksCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorCheckDescription>(checks.size());
