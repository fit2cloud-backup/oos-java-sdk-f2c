    ...
    if (describeServicesRequest == null) {
        ...
        try {
          ...
          jsonWriter.object();
            ...
            cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> serviceCodeListList = (cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>)(describeServicesRequest.getServiceCodeList());
