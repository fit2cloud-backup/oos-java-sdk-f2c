...
public class SeverityLevelJsonUnmarshaller implements Unmarshaller<SeverityLevel, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("code", targetDepth)) {
                    context.nextToken();
                    severityLevel.setCode(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    severityLevel.setName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static SeverityLevelJsonUnmarshaller getInstance() {
        if (instance == null) instance = new SeverityLevelJsonUnmarshaller();
        return instance;
    }
}
