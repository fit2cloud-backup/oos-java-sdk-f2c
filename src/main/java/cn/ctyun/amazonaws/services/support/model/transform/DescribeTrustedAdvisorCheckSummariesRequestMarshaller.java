    ...
    if (describeTrustedAdvisorCheckSummariesRequest == null) {
        ...
        try {
          ...
          jsonWriter.object();
            ...
            cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> checkIdsList = (cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>)(describeTrustedAdvisorCheckSummariesRequest.getCheckIds());
