...
public class DescribeSeverityLevelsResult  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<SeverityLevel> severityLevels;
    ...
    public java.util.List<SeverityLevel> getSeverityLevels() {
        ...
        if (severityLevels == null) {
              severityLevels = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<SeverityLevel>();
    ...
    public void setSeverityLevels(java.util.Collection<SeverityLevel> severityLevels) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<SeverityLevel> severityLevelsCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<SeverityLevel>(severityLevels.size());
