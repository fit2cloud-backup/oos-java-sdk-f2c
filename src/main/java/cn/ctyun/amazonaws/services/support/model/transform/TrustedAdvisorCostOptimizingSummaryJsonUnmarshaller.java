...
public class TrustedAdvisorCostOptimizingSummaryJsonUnmarshaller implements Unmarshaller<TrustedAdvisorCostOptimizingSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("estimatedMonthlySavings", targetDepth)) {
                    context.nextToken();
                    trustedAdvisorCostOptimizingSummary.setEstimatedMonthlySavings(DoubleJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("estimatedPercentMonthlySavings", targetDepth)) {
                    context.nextToken();
                    trustedAdvisorCostOptimizingSummary.setEstimatedPercentMonthlySavings(DoubleJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    private static TrustedAdvisorCostOptimizingSummaryJsonUnmarshaller instance;
    public static TrustedAdvisorCostOptimizingSummaryJsonUnmarshaller getInstance() {
        if (instance == null) instance = new TrustedAdvisorCostOptimizingSummaryJsonUnmarshaller();
        return instance;
    }
}
