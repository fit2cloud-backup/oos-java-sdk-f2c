 ...
 */
public class DescribeTrustedAdvisorChecksRequestMarshaller implements Marshaller<Request<DescribeTrustedAdvisorChecksRequest>, DescribeTrustedAdvisorChecksRequest> {

    

    public Request<DescribeTrustedAdvisorChecksRequest> marshall(DescribeTrustedAdvisorChecksRequest describeTrustedAdvisorChecksRequest) {
    if (describeTrustedAdvisorChecksRequest == null) {
        throw new AmazonClientException("Invalid argument passed to marshall(...)");
    }

        Request<DescribeTrustedAdvisorChecksRequest> request = new DefaultRequest<DescribeTrustedAdvisorChecksRequest>(describeTrustedAdvisorChecksRequest, "AWSSupport");
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (describeTrustedAdvisorChecksRequest.getLanguage() != null) {
                jsonWriter.key("language").value(describeTrustedAdvisorChecksRequest.getLanguage());
            }
