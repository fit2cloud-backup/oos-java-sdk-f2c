...
public class DescribeCommunicationsResult  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Communication> communications;
    ...
    public java.util.List<Communication> getCommunications() {
        ...
        if (communications == null) {
              communications = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Communication>();
    ...
    public void setCommunications(java.util.Collection<Communication> communications) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Communication> communicationsCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Communication>(communications.size());
