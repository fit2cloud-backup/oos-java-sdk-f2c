...
public class TrustedAdvisorCheckResult  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorResourceDetail> flaggedResources;
    ...
    public java.util.List<TrustedAdvisorResourceDetail> getFlaggedResources() {
        ...
        if (flaggedResources == null) {
              flaggedResources = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorResourceDetail>();
    ...
    public void setFlaggedResources(java.util.Collection<TrustedAdvisorResourceDetail> flaggedResources) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorResourceDetail> flaggedResourcesCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorResourceDetail>(flaggedResources.size());
