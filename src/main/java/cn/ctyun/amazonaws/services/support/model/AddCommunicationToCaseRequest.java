...
/**
 * Container for the parameters to the {@link cn.ctyun.amazonaws.services.support.AWSSupport#addCommunicationToCase(AddCommunicationToCaseRequest) AddCommunicationToCase operation}.
 * <p>
 ...
 * </p>
 *
 * @see cn.ctyun.amazonaws.services.support.AWSSupport#addCommunicationToCase(AddCommunicationToCaseRequest)
 */
public class AddCommunicationToCaseRequest extends AmazonWebServiceRequest  implements Serializable  {
     ...
     * <b>Length: </b>0 - 10<br/>
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> ccEmailAddresses;
    ...
    public java.util.List<String> getCcEmailAddresses() {
        ...
        if (ccEmailAddresses == null) {
              ccEmailAddresses = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>();
    ...
    public void setCcEmailAddresses(java.util.Collection<String> ccEmailAddresses) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> ccEmailAddressesCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>(ccEmailAddresses.size());
