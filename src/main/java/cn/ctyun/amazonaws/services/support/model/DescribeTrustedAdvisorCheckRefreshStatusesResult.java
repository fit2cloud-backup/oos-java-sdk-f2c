...
public class DescribeTrustedAdvisorCheckRefreshStatusesResult  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorCheckRefreshStatus> statuses;
    ...
    public java.util.List<TrustedAdvisorCheckRefreshStatus> getStatuses() {
        ...
        if (statuses == null) {
              statuses = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorCheckRefreshStatus>();
    ...
    public void setStatuses(java.util.Collection<TrustedAdvisorCheckRefreshStatus> statuses) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorCheckRefreshStatus> statusesCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorCheckRefreshStatus>(statuses.size());
