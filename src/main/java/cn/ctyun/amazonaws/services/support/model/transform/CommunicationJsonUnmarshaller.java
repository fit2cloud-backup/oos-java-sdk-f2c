...
public class CommunicationJsonUnmarshaller implements Unmarshaller<Communication, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("caseId", targetDepth)) {
                    context.nextToken();
                    communication.setCaseId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("body", targetDepth)) {
                    context.nextToken();
                    communication.setBody(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("submittedBy", targetDepth)) {
                    context.nextToken();
                    communication.setSubmittedBy(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static CommunicationJsonUnmarshaller getInstance() {
        if (instance == null) instance = new CommunicationJsonUnmarshaller();
        return instance;
    }
}
