 ...
 */
public class TrustedAdvisorCategorySpecificSummaryJsonUnmarshaller implements Unmarshaller<TrustedAdvisorCategorySpecificSummary, JsonUnmarshallerContext> {

    

    public TrustedAdvisorCategorySpecificSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("costOptimizing", targetDepth)) {
                    context.nextToken();
                    trustedAdvisorCategorySpecificSummary.setCostOptimizing(TrustedAdvisorCostOptimizingSummaryJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static TrustedAdvisorCategorySpecificSummaryJsonUnmarshaller getInstance() {
        if (instance == null) instance = new TrustedAdvisorCategorySpecificSummaryJsonUnmarshaller();
        return instance;
    }
}
