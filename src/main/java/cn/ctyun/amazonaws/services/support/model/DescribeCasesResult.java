...
public class DescribeCasesResult  implements Serializable  {
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<CaseDetails> cases;
    ...
    public java.util.List<CaseDetails> getCases() {
        ...
        if (cases == null) {
              cases = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<CaseDetails>();
    ...
    public void setCases(java.util.Collection<CaseDetails> cases) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<CaseDetails> casesCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<CaseDetails>(cases.size());
