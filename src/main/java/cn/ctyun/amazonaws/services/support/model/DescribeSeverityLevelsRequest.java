...
/**
 * Container for the parameters to the {@link cn.ctyun.amazonaws.services.support.AWSSupport#describeSeverityLevels(DescribeSeverityLevelsRequest) DescribeSeverityLevels operation}.
 * <p>
 * This action returns the list of severity levels that you can assign to an AWS Support case. The severity level for a case is also a field in the
 * CaseDetails data type included in any CreateCase request.
 * </p>
 *
 * @see cn.ctyun.amazonaws.services.support.AWSSupport#describeSeverityLevels(DescribeSeverityLevelsRequest)
 */
