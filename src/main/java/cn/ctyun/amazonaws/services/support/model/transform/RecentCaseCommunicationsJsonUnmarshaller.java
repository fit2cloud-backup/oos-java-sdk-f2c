 ...
 */
public class RecentCaseCommunicationsJsonUnmarshaller implements Unmarshaller<RecentCaseCommunications, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    recentCaseCommunications.setNextToken(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static RecentCaseCommunicationsJsonUnmarshaller getInstance() {
        if (instance == null) instance = new RecentCaseCommunicationsJsonUnmarshaller();
        return instance;
    }
}
