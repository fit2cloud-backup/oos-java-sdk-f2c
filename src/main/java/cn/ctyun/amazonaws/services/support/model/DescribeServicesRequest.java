...
/**
 * Container for the parameters to the {@link cn.ctyun.amazonaws.services.support.AWSSupport#describeServices(DescribeServicesRequest) DescribeServices operation}.
 * <p>
 ...
 * </p>
 *
 * @see cn.ctyun.amazonaws.services.support.AWSSupport#describeServices(DescribeServicesRequest)
 */
public class DescribeServicesRequest extends AmazonWebServiceRequest  implements Serializable  {
     ...
     * <b>Length: </b>0 - 100<br/>
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> serviceCodeList;
    ...
    public java.util.List<String> getServiceCodeList() {
        ...
        if (serviceCodeList == null) {
              serviceCodeList = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>();
    ...
    public void setServiceCodeList(java.util.Collection<String> serviceCodeList) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String> serviceCodeListCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<String>(serviceCodeList.size());
