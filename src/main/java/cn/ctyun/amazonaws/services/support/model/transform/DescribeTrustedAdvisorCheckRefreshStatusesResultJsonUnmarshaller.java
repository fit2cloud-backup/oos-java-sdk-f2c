 ...
 */
public class DescribeTrustedAdvisorCheckRefreshStatusesResultJsonUnmarshaller implements Unmarshaller<DescribeTrustedAdvisorCheckRefreshStatusesResult, JsonUnmarshallerContext> {

    

    public DescribeTrustedAdvisorCheckRefreshStatusesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static DescribeTrustedAdvisorCheckRefreshStatusesResultJsonUnmarshaller instance;
    public static DescribeTrustedAdvisorCheckRefreshStatusesResultJsonUnmarshaller getInstance() {
        if (instance == null) instance = new DescribeTrustedAdvisorCheckRefreshStatusesResultJsonUnmarshaller();
        return instance;
    }
}
