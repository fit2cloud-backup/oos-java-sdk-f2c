...
public class Service  implements Serializable  {
     ...
     * returned by <a href="API_DescribeServices.html"
     ...
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Category> categories;
    ...
    public java.util.List<Category> getCategories() {
        ...
        if (categories == null) {
              categories = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Category>();
    ...
    public void setCategories(java.util.Collection<Category> categories) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Category> categoriesCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<Category>(categories.size());
