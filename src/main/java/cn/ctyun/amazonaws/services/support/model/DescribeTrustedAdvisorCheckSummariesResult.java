...
public class DescribeTrustedAdvisorCheckSummariesResult  implements Serializable  {
     ...
     * request.
     */
    private cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorCheckSummary> summaries;
    ...
    public java.util.List<TrustedAdvisorCheckSummary> getSummaries() {
        ...
        if (summaries == null) {
              summaries = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorCheckSummary>();
    ...
    public void setSummaries(java.util.Collection<TrustedAdvisorCheckSummary> summaries) {
        ...
        cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorCheckSummary> summariesCopy = new cn.ctyun.amazonaws.internal.ListWithAutoConstructFlag<TrustedAdvisorCheckSummary>(summaries.size());
